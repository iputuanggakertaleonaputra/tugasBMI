...
class _ProfileState extends State<Profile> {
  ...
  Widget build(BuildContext context) {
    ...
    child: Text(
        'saya merupakan mahasiswa UNDIKSHA yang berasal dari prodi SISTEM INFORMASI,Disini saya baru semester 5, disini saya mencoba untuk membuat aplikasi penghitungan BMI.',
